...
void solve(){
	...
	while(q--){
		int x1 ,y1,x2,y2;
		cin>>x1>>y1>>x2>>y2;
		ll x = arr[x2][y2] - arr[x1-1][y2] - arr[x2][y1-1] + arr[x1-1][y1-1];
		cout<<x<<endl;
	}
...
// 
	...
	// while(q--){
		// int x1, y1, x2, y2;
		// cin >> x1 >> y1 >> x2 >> y2;
		// ll sum = arr[x2][y2] - arr[x1 - 1][y2] - arr[x2][y1 - 1] + arr[x1 - 1][y1 - 1];
		// cout << sum << "\n";
	// }
// }
